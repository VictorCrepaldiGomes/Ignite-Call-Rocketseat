...
import StepperLayout from "@/components/ui/origin_ui/stepper";
...
export default function RegisterPage() {
  ...
  async function handleRegister(data: RegisterFormData) {
    ...
    // Por exemplo, enviar os dados para uma API ou serviço de backend
  }
      ...
      <header className="w-full max-w-xl text-center mb-8 rounded-md p-10 border border-emerald-500">
        ...
        <div className="">
          ...
          >
            <label
              htmlFor=""
              className="text-white font-bold text-1xl text-left"
            >
              Nome de usuário
            </label>
            ...
            <div className="grid grid-cols-1 gap-4 mt-2">
              ...
              {errors.username ? (
                ...
                <span className="text-gray-400">
                  É necessário um usuário e um nome válidos para continuar.
                </span>
              )}{" "}
              <label
                htmlFor=""
